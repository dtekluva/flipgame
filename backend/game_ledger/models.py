...
class GameSession(models.Model):
    ...
    user_id = models.CharField(max_length=100, help_text="Identifier for the player")
    ...
    def __str__(self):
        return f"Game {self.id} - User {self.user_id} ({self.status})"
...
class GameEvent(models.Model):
    ...
    def __str__(self):
        return f"{self.event_type} - {self.session.user_id}"
